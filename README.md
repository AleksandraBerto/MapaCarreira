...
🚀 **Funcionalidades**
- Seções com níveis de carreira (Estagiária → Júnior → Plena → Sênior → Engenheira Sênior)
- Roadmap de aprendizado por etapa
- Lista de soft skills e hard skills
- Layout responsivo pronto para uso em portfólio ou impressão (PDF)
- Arquivos estáticos (HTML/CSS/JS) fáceis de customizar

🔧 **Tecnologias**
- HTML5
- CSS (Bootstrap e/ou CSS custom)
